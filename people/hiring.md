...
- Colocate development team or make it possible to meet in one physical space often. Rationale:
  ...
  - Fully remote peers struggle to culturally align
  - If hybrid working is unavoidable, set guidelines to [make it work](./hybrid.md).
- Keep team small (< 10). Small teams have
  - High cultural alignment
  - Low communication cost
  - Low decision-making latency
- Hire sparingly, and always with the aim to increase talent _density_
  - Prefer to train and promote from within instead of hiring
  ...
  - Seek those with an aptitude to build from first principles
- Seek intellectual diversity (be open to talent from unrelated domains)
- Maintain a balance of _innovators_ and _maintainers_ in the team. (Innovators are disruptive. Maintainers provide stability.)
